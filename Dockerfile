...
ENV LOCAL_MODEL=qwen3-4b \
    ...
    THRESHOLDS_JSON='{"code_debugging": 0.0, "code_generation": 0.5, "factual_knowledge": 0.0, "logical_reasoning": 1.01, "math_reasoning": 0.0, "ner": 0.0, "sentiment_classification": 0.0, "text_summarization": 0.0}' \
